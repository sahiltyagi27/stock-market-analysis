...
func main() {
	...
	rsLookback := flag.Int("rs-lookback", 0, "relative-strength lookback vs benchmark candles (0 = disabled; backtests show it reduces returns)")
	...
	sectorRSLookback := flag.Int("sector-rs-lookback", 0, "sector-strength lookback vs benchmark candles (0 = disabled; backtests show it reduces returns)")
